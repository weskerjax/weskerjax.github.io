...
function Engine(){
	...
	this.rods.push(new Rod(this.center, this.rodCenter, $("rod_5_line"), $("rod_5"), $("piston_5"))); 
	this.rods.push(new Rod(this.center, this.rodCenter, $("rod_6_line"), $("rod_6"), $("piston_6"))); 
	this.rods.push(new Rod(this.center, this.rodCenter, $("rod_7_line"), $("rod_7"), $("piston_7"))); 
	this.rods.push(new Rod(this.center, this.rodCenter, $("rod_8_line"), $("rod_8"), $("piston_8"))); 
}
